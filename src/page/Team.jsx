        ...
        <Col sm="4">
          <Card style={CardContainer}>
            <CardImg
              top
              width="100%"
              src={require(`../image/Team/miftah.jpg`)}
              alt="Miftah Faris"
            />
            <CardBody>
        ...
        <Col sm="4">
          <Card style={CardContainer}>
            <CardImg
              top
              width="100%"
              src={require(`../image/Team/fuad.jpg`)}
              alt="Fuad Baskara"
            />
            <CardBody>
        ...
        <Col sm="4">
          <Card style={CardContainer}>
            <CardImg
              top
              width="100%"
              src={require(`../image/Team/yanuar.jpg`)}
              alt="Yanuar Yudhistira"
            />
            <CardBody>
        ...
        <Col sm="4">
          <Card style={CardContainer}>
            <CardImg
              top
              width="100%"
              src={require(`../image/Team/dedek.jpeg`)}
              alt="Dedek Julianto"
            />
            <CardBody>
        ...
        <Col sm="4">
          <Card style={CardContainer}>
            <CardImg
              top
              width="100%"
              src={require(`../image/Team/rizal.jpg`)}
              alt="Rizal Zulkarnain"
            />
            <CardBody>
        ...
        <Col sm="4">
          <Card style={CardContainer}>
            <CardImg
              top
              width="100%"
              src={require(`../image/Team/dodi.jpg`)}
              alt="Stefanus Doddy"
            />
            <CardBody>
